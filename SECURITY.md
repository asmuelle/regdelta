...
`regdelta` is under active pre-1.0 development. Security fixes are applied only to
...
1. Open the [**Security** tab](https://github.com/asmuelle/regdelta/security) of this repository.
2. Click **Report a vulnerability** to open a private advisory
   ([direct link](https://github.com/asmuelle/regdelta/security/advisories/new)).
...
- **CodeQL** — static-analysis code scanning on every push and pull request.
